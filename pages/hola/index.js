        ...
        <div className="w-full md:w-6/12 px-12 md:px-4 mt-20 md:mt-0">
          <div className="md:pr-12">
            <div className="relative flex flex-1 flex-col">
              ...
              <p className="mb-4 text-lg leading-tight">
                De forma autodidacta aprendí a domar la "aguja mágica" y ese fue
                el inicio de un gran camino de experimentación con telas, lanas
                y muchas agujas de formas raras que, con mis conocimientos de
                diseño, fotografía e ilustración, me llevó a crear un gran
                portfolio de almohadones, cuadros y muñecos, donde las texturas
                son las protagonistas.
              </p>
              <p className="mb-4 text-lg leading-tight">
                Actualmente reparto mi tiempo entre el diseño gráfico freelance
                y este hermoso proyecto artístico en el que me reto a que cada
                bordado sea un nuevo desafío.
              </p>
              <p className="mb-4 text-lg leading-tight">
