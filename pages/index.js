    ...
    <div className="absolute top-0 left-0 w-full min-h-screen -z-10">
      ...
      <div className="relative flex flex-1 flex-col justify-center items-center bg-black text-white text-2xl p-12 md:p-48 h-screen md:h-96">
        ...
        <span className="text-center mb-3">
          Hago piezas textiles únicas con tela, lana y agujas de formas muy extrañas, donde las texturas son las principales protagonistas.
        </span>
      ...
      <div className="flex flex-col md:flex-row">
        <div className="flex flex-1 flex-row">
          ...
          <div className="flex flex-1 flex-col justify-between bg-white text-black h-50vw md:h-25vw">
            <span className="m-6 text-xl lg:m-12 md:text-xl xl:text-4xl leading-none">portfolio</span>
        ...
        <div className="flex flex-1 flex-row">
          <div className="relative flex-1 h-80 md:h-full">
            <Image src="/images/home_barbudo.jpg" layout="fill" objectFit="cover" alt="Bordado Barbudo" />
          </div>
        </div>
      </div>
      <div className="flex flex-col md:flex-row">
        ...
        <div className="flex flex-1 flex-row">
          <div className="flex flex-1 flex-col justify-between bg-cb-green text-black h-50vw md:h-25vw">
            <span className="m-6 text-xl lg:m-12 md:text-xl xl:text-4xl leading-none">mis cursos online de punch needle</span>
      ...
      <div className="flex flex-col h-48 md:h-25vw md:flex-row">
        <div className="relative flex-1 md:h-full">
          <Image src="/images/home_punch_needle_fan_club.jpg" layout="fill" objectFit="cover" alt="Bordado Punch Needle fan club" />
        </div>
      </div>
      <div className="flex flex-col-reverse md:flex-row">
        <div className="flex flex-1 flex-row h-50vw md:h-25vw">
          ...
          <div className="relative flex-1 h-full">
            <Image src="/images/home_barbudo_byn.svg" layout="fill" objectFit="cover" alt="Bordado Barbudo B&N" />
          </div>
        </div>
        <div className="flex flex-1 flex-row">
          <div className="flex flex-1 flex-col justify-between bg-cb-gray text-black h-50vw md:h-25vw">
            <span className="m-6 text-xl lg:m-12 md:text-xl xl:text-4xl leading-none">¡tu kit de bordado!</span>
            <ReadMoreLink href="/tienda" className="m-6 lg:m-12" color="black">
              VER MÁS
            </ReadMoreLink>
          </div>
          <div className="flex flex-1 flex-col justify-between bg-cb-green text-black h-50vw md:h-25vw">
            <span className="m-6 text-xl lg:m-12 md:text-xl xl:text-4xl leading-none">tienda online</span>
            <ReadMoreLink href="/tienda" className="m-6 lg:m-12" color="black">
              VER MÁS
            </ReadMoreLink>
          </div>
      ...
      <div className="flex flex-col md:flex-row">
        <div className="flex flex-1 flex-row">
          <div className="flex flex-1 flex-col justify-between bg-cb-white text-black h-50vw md:h-25vw">
            <span className="m-6 text-xl lg:m-12 md:text-xl xl:text-4xl leading-none">prensa</span>
            <ReadMoreLink href="/prensa" className="m-6 lg:m-12" color="black">
              VER MÁS
            </ReadMoreLink>
          </div>
          <div className="flex flex-1 flex-col justify-between bg-black text-white h-50vw md:h-25vw">
            <span className="m-6 text-xl lg:m-12 md:text-xl xl:text-4xl leading-none">contacto</span>
        ...
        <div className="flex flex-1 flex-row h-50vw md:h-25vw">
          <div className="relative flex-1 h-full">
            <Image src="/images/home_bastidor.jpg" layout="fill" objectFit="cover" alt="Bastidor" />
          </div>
